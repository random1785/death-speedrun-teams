...
tellraw @a [{"bold":true,"color":"red","underline":true,"text":"BETA TESTING Team-based "},{"text":"death speedruns has been loaded! Use /function a:start to begin the games!","color":"green"}]
